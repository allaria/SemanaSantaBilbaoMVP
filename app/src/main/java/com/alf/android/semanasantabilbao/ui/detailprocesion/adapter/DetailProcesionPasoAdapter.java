...
public class DetailProcesionPasoAdapter extends RecyclerView.Adapter<DetailProcesionPasoAdapter.Holder>{

    private static final String LOG_TAG = DetailProcesionPasoAdapter.class.getSimpleName();
    private DetailProcesionPasoAdapter.PasoClickListener pasoClickListener;
    private List<Paso> mPasos;
    private Context context;

    @Inject
    public DetailProcesionPasoAdapter() {
    ...
    public DetailProcesionPasoAdapter.PasoClickListener getPasoClickListener() {
        return pasoClickListener;
    }

    public void setPasoClickListener(DetailProcesionPasoAdapter.PasoClickListener pasoClickListener) {
